...
from .utils_GLOW import split_feature, compute_same_pad
...
class InvertibleConv1x1(nn.Module):
    ...
    def get_weight(self, input, reverse):
        ...
        if not self.LU_decomposed:
            ...
            if reverse:
                self.weight = torch.inverse(self.weight)
            else:
    ...
    def get_weight(self, input, reverse):
        ...
        self.weight = nn.Parameter(weight.view(self.w_shape[0], self.w_shape[1], 1, 1))
        self.bias = None
        #return self.weight.view(self.w_shape[0], self.w_shape[1], 1, 1), dlogdet
        return dlogdet

    def forward(self, input, logdet=None, reverse=False):
    
        dlogdet = self.get_weight(input, reverse)
