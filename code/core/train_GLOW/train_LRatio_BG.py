...
def main(
    ...
    checkpoint_handler = ModelCheckpoint(
        output_dir, "glow", n_saved=1, require_empty=False
    )
    ...
    def evaluate(engine):
        ...
        if engine.state.epoch%10 == 0:
            print('Hello~~~~~~~')
            torch.save(model.state_dict(), '../../../saved_models/' + f'GLOW_{train_dist}/glow_ratio_{ratio}_decay_{weight_decay}_epoch_{engine.state.epoch}.pth') # hard coded
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_dir', type=str, default='../../../saved_models/GLOW_cifar10/LRatio_bg')
    ...
    if opt.train_dist == 'cifar10':
        ...
        opt.K = 16
        opt.L = 2
        opt.output_dir = '../../../saved_models/GLOW_fmnist/LRatio_bg'
        opt.split = False
