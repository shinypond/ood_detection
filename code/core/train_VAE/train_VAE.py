...
#############################################################
    ...
    torch.save(netG.state_dict(), experiment + f'/netG_ngf_{ngf}_nz_{nz}_beta_{beta}_augment_{opt.augment}.pth')
    torch.save(netE.state_dict(), experiment + f'/netE_ngf_{ngf}_nz_{nz}_beta_{beta}_augment_{opt.augment}.pth')
