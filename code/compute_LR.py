...
import core.train_VAE.DCGAN_VAE_pixel as DVAE
...
if __name__=="__main__":
    ...
    parser.add_argument('--ood', help='ood dataset')
    ...
    parser.add_argument('--state_E', default='../saved_models/VAE_cifar10/netE_pixel_ngf_64_nz_100_beta_1.0_augment_miracle_epoch_200.pth', help='path to encoder checkpoint')
    parser.add_argument('--state_G', default='../saved_models/VAE_cifar10/netG_pixel_ngf_64_nz_100_beta_1.0_augment_miracle_epoch_200.pth', help='path to decoder checkpoint')
    ...
    for i, (xi, _) in enumerate(test_loader_cifar):
...
###################################################################################################    
    ...
    for i, xi in enumerate(test_loader_svhn):
        try: 
            xi, _ = xi
        except:
            pass
