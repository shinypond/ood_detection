# -*- coding: utf-8 -*-
"""
Created on Fri Apr 16 14:26:15 2021
...
def Calculate_Vanilafisher(netE,
                             netG,
                             dataloader,
                             dicts,
                             opt,
    ...
    for i, (x, _) in enumerate(tqdm(dataloader, desc='Calculate Fisher', unit='step')):
...
def Calculate_Vanilascore(netE,
                    netG,
                    dataloader,
                    dicts,
                    Grads,
    ...
    optimizer2 = optim.SGD(netG.parameters(), lr=0,momentum=0)
    score = []
    for i, x in enumerate(tqdm(dataloader, desc='Calculate Score', unit='step')):
