...
if __name__=="__main__":
    ...
    parser.add_argument('--num_iter', default=300, help='number of iteration')
    ...
    if opt.experiment == 'fmnist':
        ...
        opt.nz = 200
        opt.ngf = 64
        opt.ood_list = ['celeba', 'lsun', 'cifar100', 'mnist', 'fmnist', 'kmnist', 'omniglot', 'notmnist', 'trafficsign', 'noise', 'constant']
    ...
    for ood in opt.ood_list:
        ...
        for i, xi in enumerate(dataloader):
            ...
            if i >= 4999: #test for 500 samples
                break
                
        np.save(f'./array/LR(Z)/{opt.experiment}_{ood}_regret.npy', NLL_regret)