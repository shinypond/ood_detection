...
if __name__=="__main__":
    ...
    parser.add_argument('--state_E', default='../saved_models/cifar_old/netE_ngf128nz100beta10lr5hflip.pth', help='path to encoder checkpoint')
    parser.add_argument('--state_G', default='../saved_models/cifar_old/netG_ngf128nz100beta10lr5hflip.pth', help='path to encoder checkpoint')
...
#                                             shuffle=True, num_workers=int(opt.workers))
    ...
    for i, (x, _) in enumerate(test_loader_cifar):
...
###########################################################################################
    ...
    Complexity_test_ood = []
    difference_ood = []
    for i, (x, _) in enumerate(test_loader_svhn):
